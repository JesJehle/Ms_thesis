...
To understand the reasons for EE's performance EE's underlying system architecture and the computation service need to be introduced.
The following section gives a brief introduction to the provided data catalog and the system architecture that is essential to understand EE's performancee.
...
\subsection{Reasons of the performance of Earth Engine}
