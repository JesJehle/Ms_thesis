...
\usepackage[labelfont=bf]{caption}   % allows text to flow around a                

%\usepackage{color}



%\definecolor{myCol}{rgb}{0.58,0,0.82}
...
\def\supervisor{Supervisor: M.Sc. Severin Hauenstein}
\def\cosupervisor{Co-supervisor: M.Sc. Mirko Mälicke}
\def\examiner{Examiner: Prof. Dr Carsten Dormann,
...
%  \vskip 2em%
  ...
  \vskip 1em%
   \begin{figure}[h]
     \begin{center}
       \includegraphics[width=12cm]{images/logo_2-cropped.pdf}
    \end{center}
  \end{figure}
 % \vskip 2em%
\end{center}
